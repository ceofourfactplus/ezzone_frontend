    ...
    <div class="table">
      <div class="row m-0">
        <div class="col-5 w-100 p-0">
          ...
          <input type="date" v-model="start_date" name="start_date" id="start_date" />
        </div>
        <div class="col-5 w-100 p-0">
        ...
        <div class="col-2 w-100">
          <button class="btn-b w-100" type="submit" @click="find_user()">submit</button>
        </div>
      </div>
      ...
      <div class="table-item row m-0 mt-2" v-for="(item,index) in data" :key="index">
...
export default {
  ...
  methods:{
    find_user(){ 
      ...
      api_user.get('work-hours/selected-time/',send_date).then(response => {
